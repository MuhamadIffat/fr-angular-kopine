...
export class ProfileComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.data = this.localStorageService.getLocalstorage(this.data,this.arrayName);
  ...
  getNewsletterInfos(newsletterData, newsletterArray):any{
    ...
    this.newsletterData = this.localStorageService.getLocalstorage(this.newsletterData,this.newsletterArray);
